...
import { corporateGroupRouter } from "./modules/corporate-group-structures/corporate-group.controller.js";
import { annualReportsRouter } from "./modules/annual-reports/annual-report.controller.js";
...
api.route("/", corporateGroupRouter);
api.route("/", annualReportsRouter);
...
app.doc("/openapi", {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "API for getting corporate group structures and annual reports for danish companies based on danish business registration numbers (CVR-numbers).",
    },
});
app.notFound((ctx) => {
    return ctx.json({
    ...
    const endpoints = [
        {
            ...
            Beskrivelse: "Returns the corporate group structure for a given danish business registration number (CVR-number).",
        },
        {
            "HTTP-Metode": "GET",
